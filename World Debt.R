...
plot.debt_to_gdp_map + 
  coord_cartesian(xlim = c(55, 155), ylim = c(05, 55)) +
  labs(title = "Public debt of Asian Copuntires"
       ,subtitle = str_c('In particular, countries in south east asia,'
                         ,'\n- have high levels of public debt.'
       )
  )
